...
float ThreeDModel::drawOctreeLeaves(Shader* myShader)
{
	if(octree != NULL)
	{
...
float ThreeDModel::getminX() {
	
	return tempminX;
}

float ThreeDModel::getminY() {
	return tempminY;
}
float ThreeDModel::getminZ() {
	return tempminZ;
}
float ThreeDModel::getmaxX() {
	return tempmaxX;
}
float ThreeDModel::getmaxY() {
	return tempmaxY;
}
float ThreeDModel::getmaxZ() {
	return tempmaxZ;
}